...
TEST_F(BatAdsRequestSignedTokensUrlRequestBuilderTest,
    BuildUrlForRPill) {
  // Arrange
  MockRPillHelper(rpill_helper_mock_, /* is_uncertain_future */ true);
