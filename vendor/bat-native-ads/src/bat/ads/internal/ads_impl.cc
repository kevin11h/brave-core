...
#include "bat/ads/internal/ad_targeting/resources/purchase_intent/purchase_intent_resources.h"
...
void AdsImpl::OnUserModelUpdated(
  ...
  } else if (ad_targeting::resource::kPurchaseIntentIds.find(id) !=
      ad_targeting::resource::kPurchaseIntentIds.end()) {
